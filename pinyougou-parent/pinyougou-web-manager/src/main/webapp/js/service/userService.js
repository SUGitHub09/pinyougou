...
app.service('userService',function($http){
    ...
    this.userBlock=function(id){
        return $http.get('../user/userBlock.do?id='+id);
    }

    this.findOneForExcel=function(id){
        return $http.get('../user/findOneForExcel.do?id='+id);
    }
	...
	this.updateStatus = function(sellerId,status){
		return $http.get('../user/updateStatus.do?sellerId='+sellerId+"&status="+status);
	}
});
